//Sprites
var trex, chao,imagemChao, subchao,nuvem, cacto, escolherCacto, tempoJogo;
...
function preload(){
  ...
  imagemCacto1 = loadImage("cacto1.png")
  imagemCacto2 = loadImage("cacto1.png")
  imagemCacto3 = loadImage("cacto1.png")
  imagemCacto4 = loadImage("cacto4.png")
  imagemCacto5 = loadImage("cacto5.png")
  imagemCacto6 = loadImage("cacto6.png")
...
function setup() {
  ...
  //criando o sprite do trex e colocando animação
  trex=createSprite(50,100,20,40)
  trex.addAnimation("correndo",trexCorrendo)
  trex.addAnimation("colidiu", trexColidiu)
  trex.scale =0.5
  
  //criando o sprite do chão e colocando a imagem
